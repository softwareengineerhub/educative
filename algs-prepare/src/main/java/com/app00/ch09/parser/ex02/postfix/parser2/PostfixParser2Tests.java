...
import com.app00.ch09.parser.ex02.postfix.parser1.PostfixSimpleParser1;

import java.util.LinkedHashMap;
import java.util.Map;

public class PostfixParser2Tests {

    public static void main(String[] args) {
        SimpleParser simpleParser = new PostfixSimpleParser1();
